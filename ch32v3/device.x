...
PROVIDE(USB_HP_CAN1_TX_IRQN = DefaultHandler);
PROVIDE(USB_LP_CAN1_RX0_IRQN = DefaultHandler);
...
PROVIDE(USBWAKEUP_IRQN = DefaultHandler);
...
PROVIDE(OTG_FS_IRQN = DefaultHandler);
PROVIDE(USBHSWAKEUP_IRQN = DefaultHandler);
PROVIDE(USBHS_IRQN = DefaultHandler);
